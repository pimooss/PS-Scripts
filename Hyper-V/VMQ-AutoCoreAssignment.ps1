...
$PhysicalAdapters | %{ Set-NetadapterVmq -Name $_.Name -BaseProcessorNumber $ThisBase -MaxProcessors $CorePerAdapter -Enabled $true ; $ThisBase = $ThisBase + $NumberOfLogicalCoresPerCPU ; Sleep -Seconds 2}
